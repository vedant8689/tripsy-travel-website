			...
			<div class="privacy">
				<div class="container">
					<h3 class="wow fadeInDown animated animated" data-wow-delay=".5s"
						style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown; color:#463560">My Tour History</h3>
	...
	;
		...
		if ($query->rowCount() > 0) {
            ...
            <tr class="bg-white border-b">
                <th scope="row" class="px-2 py-3 font-medium whitespace-nowrap text-black">
					<?php echo htmlentities($cnt); ?>
                </th>
				<td class="px-6 py-4">#BK
				...
				<?php if ($result->status == 2) {
						...
						<td>Cancelled</td>
					<?php } else { ?>
						<td class="px-6 py-4"><a href="tour-history.php?bkid=<?php echo htmlentities($result->bookid); ?>"
