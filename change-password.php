			...
			<div class="privacy">
				<div class="container">
					<h3 class="wow fadeInDown animated animated" data-wow-delay=".5s"
						style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown; color:#463560">Change Password</h3>
					<form name="chngpwd" method="post" onSubmit="return valid();">
						...
						<p style="width: 350px;">
							<button type="submit" name="submit5" style="background-color: #C8EADF; color:black; padding:5px; width:100px; border-radius:8px; font-weight:700;">Change</button>
						</p>
					</form>
