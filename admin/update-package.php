...
if (strlen($_SESSION['alogin']) == 0) {
	...
	<head>
		<title>TripSy | Admin Package Creation</title>
								...
								if ($query->rowCount() > 0) {
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<img src="pacakgeimages/<?php echo htmlentities($result->PackageImage); ?>"
														width="200">&nbsp;&nbsp;&nbsp;<a
														href="change-image.php?imgid=<?php echo htmlentities($result->PackageId); ?>"><button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-2 mt-2 rounded">Change
														Image</a></button>
												</div>
											</div>
									...
									<div class="row">
										<div class="col-sm-8 col-sm-offset-2">
											<button type="submit" name="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Update</button>
										</div>
									</div>
