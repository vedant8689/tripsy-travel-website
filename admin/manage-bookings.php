	...
	<body>
		<div class="page-container">
			...
			<div class="left-content">
				...
				<div class="relative overflow-x-auto shadow-md sm:rounded-lg h-[445px]">
    <table class="w-full text-sm text-left text-gray-500 text-gray-400">
        <thead class="text-xs text-gray-700 uppercase bg-white text-gray-400">
            <tr>
        ...
        <tbody>
            <tr class="bg-white border-b bg-white text-black">
			...
			if ($query->rowCount() > 0) {
			    ...
			    <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap ">
                    #BK - <?php echo htmlentities($result->bookid); ?>
                </th>
                <td class="px-6 py-4">
                    <?php echo htmlentities($result->fname); ?>
                </td>
                <td class="px-6 py-4">
                    <?php echo htmlentities($result->mnumber); ?>
                </td>
                <td class="px-6 py-4">
                    <?php echo htmlentities($result->email); ?>
                </td>
				<td class="px-6 py-4">
					<a class="text-black bg-white " href="update-package.php?pid=<?php echo htmlentities($result->pid); ?>"><?php echo htmlentities($result->pckname); ?></a>
				</td>
				<td class="px-6 py-4">
					<?php echo htmlentities($result->fdate); ?>
				</td>
				<td class="px-6 py-4">
				...
				<?php } else { ?>
					<td><a href="manage-bookings.php?bkid=<?php echo htmlentities($result->bookid); ?>"
						...
						/ <a href="manage-bookings.php?bckid=<?php echo htmlentities($result->bookid); ?>"
							onclick="return confirm('booking has been confirmed')">Confirm</a></td>
				<?php }}} ?>
