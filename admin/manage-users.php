...
if (strlen($_SESSION['alogin']) == 0) {
	...
	<head>
		<title>TripSy | Admin Manage Users</title>
		...
		<script type="text/javascript" src="js/jquery.basictable.min.js"></scrip>
	...
	<body>
        ...
        <tbody>
			...
			if ($query->rowCount() > 0) {
                ...
                <th scope="row" class="px-6 py-4 font-medium whitespace-nowrap text-black bg-white">
